...
fn hashtable_big_field<const N_WITNESSES: usize>(field_name: &str) {
    ...
    let mut expander_circuit: Circuit<M31Config> = layered_circuit
        .export_to_expander()
        .flatten();
    let config = expander_config::Config::new(
