...
fn test_pairing_check_gkr() {
    ...
    let mut assignment = PairingCheckGKRCircuit::<M31> {
        in1_g1: [[M31::ZERO; 48]; 2],
        in2_g1: [[M31::ZERO; 48]; 2],
        in1_g2: [[[M31::ZERO; 48]; 2]; 2],
        in2_g2: [[[M31::ZERO; 48]; 2]; 2],
    };
