...
const config: Config = {
  ...
  url: 'https://expandercompilercollection.github.io',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/PolyhedraZK/ExpanderCompilerCollection/tree/main/docs/',
        },
        theme: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Issues',
              href: 'https://github.com/PolyhedraZK/ExpanderCompilerCollection/issues',
            },
          ],
        },
        {
