...
mod tests {
    ...
    fn test_attestation_hash() {
        ...
        let beacon_beacon_block_root = [31, 28, 22, 87, 106, 251, 75, 169, 100, 167, 224, 201, 6, 63, 144, 105, 213, 235, 18,
        ...
        let source_root = [194, 212, 152, 232, 56, 145, 101, 103, 73, 230, 240, 242, 89, 129, 63, 184, 38, 157,
            86, 185, 251, 148, 157, 68, 227, 144, 241, 74, 228, 200, 206, 199];
        let target_root = [31, 28, 22, 87, 106, 251, 75, 169, 100, 167, 224, 201, 6, 63, 144, 105, 213, 235, 18,
            224, 169, 157, 122, 56, 47, 48, 28, 31, 124, 69, 38, 248];
        let domain = [1, 0, 0, 0, 187, 164, 218, 150, 53, 76, 159, 37, 71, 108, 241, 188, 105, 191, 88, 58,
            127, 158, 10, 240, 73, 48, 91, 98, 222, 103, 102, 64];
        let output = [108, 128, 22, 84, 10, 154, 231, 122, 105, 134, 112, 241, 41, 75, 92, 55, 89, 54, 23, 5,
