...
fn simple() {
        ...
        segments: vec![
            Segment {
                ...
                gate_muls: vec![GateMul {
                    ...
                    output: 0,
                    coef: Coef::Constant(CField::from(2u32)),
                }],
                gate_adds: vec![],
                gate_consts: vec![],
                gate_customs: vec![],
            ...
            Segment {
                ...
                gate_adds: vec![
                    GateAdd {
                        ...
                        output: 1,
                        coef: Coef::Constant(CField::from(3u32)),
                    },
                    GateAdd {
                        inputs: [NormalInput { offset: 1 }],
                        output: 1,
                        coef: Coef::Constant(CField::from(4u32)),
                    },
                ],
                gate_consts: vec![GateConst {
                    inputs: [],
                    output: 1,
                    coef: Coef::Constant(CField::from(5u32)),
                }],
                gate_customs: vec![],
            },
        ],
    ...
    for _ in 0..100 {
        ...
        assert_eq!(out.len(), 2);
        assert_eq!(out[0], s[0] * s[1] * s[2] * s[3] * CField::from(8u32));
        assert_eq!(
            out[1],
            s[0] * s[1] * CField::from(6u32) + s[2] * s[3] * CField::from(8u32) + CField::from(5u32)
        );
    }
}
