...
fn eval_output() {
            ...
            instructions: vec![
                ...
                InternalVariable {
                    expr: Expression::from_terms(vec![
                        ...
                        Term::new_linear(CField::from(9u32), 2),
                    ]),
                },
            ],
            constraints: vec![],
        ...
        Circuit {
            instructions: vec![InternalVariable {
                expr: Expression::from_terms(vec![
                    ...
                    Term::new_linear(CField::from(10u32), 2),
                ]),
            }],
            constraints: vec![],
            outputs: vec![3],
    ...
    let fn2 = |x: CField, y: CField| x * x + y * CField::from(10u32);
    let fn1 = |x: CField, r: &[CField]| fn2(fn2(x, r[1]), r[2]) + r[0] * CField::from(9u32);
...
fn eval_constraint() {
    ...
    for i in 0..2 {
        for j in 0..2 {
            let (_, cond) = root.eval_unsafe(vec![CField::from(i as u32), CField::from(j as u32)]);
