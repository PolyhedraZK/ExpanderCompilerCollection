    ...
    fn simple1() {
        ...
        root.circuits.insert(
            ...
            IrCircuit {
                instructions: vec![
                    InternalVariable {
                        expr: Expression::from_terms(vec![Term::new_linear(M31::from(2u32), 1)]),
                    },
                    InternalVariable {
                        expr: Expression::from_terms(vec![Term::new_linear(M31::from(3u32), 2)]),
                    },
                    InternalVariable {
                        expr: Expression::from_terms(vec![Term::new_linear(M31::from(5u32), 3)]),
                    },
                ],
                constraints: vec![],
                outputs: vec![2, 4],
