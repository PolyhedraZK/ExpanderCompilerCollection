...
use crate::{frontend::Config, zkcuda::{proof::ComputationGraph, proving_system::{structs::{ExpanderProverSetup, ExpanderVerifierSetup}, utils::pcs_testing_setup_fixed_seed}}};


pub fn local_setup_impl<C, ECCConfig>(computation_graph: &ComputationGraph<ECCConfig>) ->
    (
