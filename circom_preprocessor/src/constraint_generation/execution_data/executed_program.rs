...
use crate::constraint_generation::expression_trace::TraceRegistry;
...
impl ExecutedProgram {
    ...
    pub fn export(mut self, mut program: ProgramArchive, flags: FlagsExecution) -> ExportResult {
        ...
        crate::constraint_generation::compute_constants::manage_functions(
            &mut program,
            flags,
            &self.prime,
        )?;
        crate::constraint_generation::compute_constants::compute_vct(
            &mut temp_instances,
            &program,
            flags,
            &self.prime,
