use super::expression_trace::AExpr;
use crate::constraint_generation::environment_utils::environment::ExecutionEnvironment as EE;
use crate::constraint_generation::environment_utils::slice_types::{AExpressionSlice, TagInfo};
use crate::constraint_generation::FlagsExecution;
...
fn argument_into_slice(argument: &Argument) -> AExpressionSlice {
    ...
    let arithmetic_expressions: Vec<AExpr> = argument
        .values
        .iter()
        .map(|v| AExpr::from_raw(Number { value: v.clone() }))
        .collect();
...
fn treat_dimension(
    ...
    use crate::constraint_generation::execute::execute_constant_expression;
